"""Render Episode 1 R7D in the Episode 0 brown-and-gold visual system."""
...
def compose(config, run, *, config_path, run_path, workdir,
    ...
    if config.project_id != "ck3-war-ai-episode-01-r7d-same-battle":
    ...
    return PipelineInvocation(
        PipelineDraft(config, tuple(segments), Path("episode-01-r7d-messina-unmixed.mp4"),
                      "episode-01-r7d-messina-unmixed-v1", "video/mp4"),
