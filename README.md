...
2. 开局弹出「终末之契」：接受则获得可成长特质【琉焰之视】（0–100 经验、每 10 经验一级，每级额外 +10% 压力获取）并进入商店；特质悬浮提示会即时预览当前分数；拒绝则本局与无 mod 无异
...
4. 琉焰卿的「垂青会」：开局及此后每 3 年，可从随机 3 项祝福中领 1 项；每领 1 祝福必须再从满足最低稀有度的 2 项诅咒中选 1，并使【琉焰之视】获得 1 经验。每场至多 3 对；每次拒绝整场垂青，最终结算 -1%。池子见 [docs/blessing-curse-pools.md](docs/blessing-curse-pools.md)
