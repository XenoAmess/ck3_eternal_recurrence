...
3. 游戏规则可选择绝对/本世成长赛道，以及 0%/25%/50%/100% 余烬继承；推荐默认是本世成长 + 100% 继承，继承预算不另设上限。非零预算会打开「轮回当铺」（分页），可购买六维属性、资源、借命层数和 1133 分的免费宗教改革；高位阶另有 10000 分【万国贡火】、50000 分【借来一代】和 100000 分【六维登神】。每件普通商品每次购买后涨价 ×1.2；剩余分数开始此生时等量转为金币
