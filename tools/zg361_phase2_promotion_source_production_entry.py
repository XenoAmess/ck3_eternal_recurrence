...
from zg361_phase2_promotion_vanilla_historical_character_interrupt_contracts import (
...
from zg361_phase2_promotion_manager_prison_contracts import (
...
KNOWN_TIMELINE_INTERRUPTS.update(MANAGER_PRISON_TIMELINE_CONTRACTS)
