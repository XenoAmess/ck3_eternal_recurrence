#!/usr/bin/env python3
"""Exact PP feedback-bargaining timeline interrupt contracts."""
...
PP_BARGAINING_TIMELINE_CONTRACTS: Final[
    dict[str, dict[str, object]]
] = {
    "zg361pp.149": {
        # R205 reached T-domain stage 02's lower-rating compensation prompt.
        # The six zg361_pp_prompt_* names bind the current case; the other
        # names are inherited state, but the fail-closed contract preserves
        # the complete observed frame and all seventeen character aliases.
        # Routes 1/2 create funded/oral obligations and consume resources.
        # Route 3 consumes this prompt and dispatches the next card without a
        # payment or obligation, making it the least destructive continuation
        # through the complete migration tree.
        "date_raw": 53186856,
