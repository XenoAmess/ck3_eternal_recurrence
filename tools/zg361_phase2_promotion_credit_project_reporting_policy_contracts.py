...
CREDIT_PROJECT_REPORTING_POLICY_TIMELINE_CONTRACTS: Final[
    ...
    "zg361cp.55": {
        # R224 reached attention/read accounting. Routes A/B both consume the
        # read, increment both object versions, and schedule .60 D+1. A spends
        # one of two free attention points, records one read, and adds five
        # visibility; B spends two and adds ten, while C opens defer/debt. A
        # is the minimum complete read and preserves the full I tree.
        "date_raw": 53187312,
        "date_policy": "product-observation-window",
        "root_character_id": 32904,
        "character_scopes": _CREDIT_PROJECT_REPORTING_POLICY_CHARACTER_SCOPES,
