...
def render_triggers() -> str:
    lines = [
        ...
        "\ttrigger_if = {",
        "\t\tlimit = { scope:aub_payer = { has_character_flag = aub_funding_treasury_only } }",
        "\t\tscope:aub_payer = {",
        "\t\t\thas_treasury = yes",
        "\t\t\ttreasury >= $GOLD$",
        "\t\t}",
        "\t}",
        "\ttrigger_else_if = {",
        "\t\tlimit = { scope:aub_payer = { has_character_flag = aub_funding_personal_only } }",
        "\t\tscope:aub_payer = { gold >= $GOLD$ }",
        "\t}",
        "\ttrigger_else = {",
        "\t\tscope:aub_payer = {",
        "\t\t\tOR = {",
...
def _resource_limits(edge: BuildingEdge) -> list[str]:
    ...
    lines = [
        f"\t\t\taub_can_pay_gold_building_cost_trigger = {{ GOLD = {resources['gold']} }}",
    ]
...
def render_effects() -> str:
    lines = [
        ...
        "}",
        "",
        "aub_transfer_auto_build_to_player_heir_effect = {",
        "\tif = {",
        "\t\tlimit = {",
        ...
        "\t\t}",
        "\t\tplayer_heir = {",
        "\t\t\t# The successor must receive one exact policy, even if that character",
        "\t\t\t# already carried stale flags from an earlier player-controlled life.",
        ...
        "\t\t\tif = {",
        "\t\t\t\tlimit = { root = { has_character_flag = aub_funding_treasury_only } }",
        "\t\t\t\tadd_character_flag = aub_funding_treasury_only",
        "\t\t\t}",
        "\t\t\telse_if = {",
        "\t\t\t\tlimit = { root = { has_character_flag = aub_funding_personal_only } }",
        "\t\t\t\tadd_character_flag = aub_funding_personal_only",
        "\t\t\t}",
        "\t\t\tif = {",
        "\t\t\t\tlimit = { root = { has_character_flag = aub_pause_when_over_domain_limit } }",
