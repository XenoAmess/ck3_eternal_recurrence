#!/usr/bin/env python3
"""Unit tests for the Tributary Expansion Directives release builder."""
...
class BuildTributaryExpansionDirectivesReleaseTests(unittest.TestCase):
    def setUp(self) -> None:
        self.temp = tempfile.TemporaryDirectory(prefix="ted-builder-test-")
    ...
    def test_missing_and_extra_files_fail_closed(self) -> None:
        (self.source / "common/script_values/ted_tributary_expansion_values.txt").unlink()
    ...
    def test_manifest_verification_and_tamper_detection(self) -> None:
        ...
        (staging / "common/script_values/ted_tributary_expansion_values.txt").write_bytes(
            b"tampered"
        )
