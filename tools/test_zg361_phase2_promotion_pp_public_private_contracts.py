#!/usr/bin/env python3
"""Focused tests for purpose-split PP public/private feedback contracts."""
...
import zg361_phase2_promotion_pp_public_private_contracts as public_private  # noqa: E402
...
class PpPublicPrivateContractTests(unittest.TestCase):
    def _r209_frame(self) -> tuple[
        dict[str, object], dict[str, object], dict[str, object]
    ]:
        contract = public_private.PP_PUBLIC_PRIVATE_TIMELINE_CONTRACTS[
            "zg361pp.155"
        ]
        ...
        context = {
            ...
            "event_definition_key": "zg361pp.155",
            "current_event_instance_id": 132,
            "date_raw": 53186952,
        ...
        event = {"event_instance_id": 132}
        return snapshot, event, context

    def test_r209_exact_frame_selects_policy_debt_continuation(self) -> None:
        contracts = public_private.PP_PUBLIC_PRIVATE_TIMELINE_CONTRACTS
        self.assertEqual(set(contracts), {"zg361pp.155"})
        contract = contracts["zg361pp.155"]
        self.assertIs(
            production.KNOWN_TIMELINE_INTERRUPTS["zg361pp.155"],
            contract,
        )
        snapshot, event, context = self._r209_frame()
        checks = production._known_interrupt_checks(
            snapshot=snapshot,
            event=event,
            context=context,
            event_key="zg361pp.155",
            contract=contract,
        )
    ...
    def test_r209_frame_rejects_date_scope_and_alias_drift(self) -> None:
        contract = public_private.PP_PUBLIC_PRIVATE_TIMELINE_CONTRACTS[
            "zg361pp.155"
        ]
        snapshot, event, context = self._r209_frame()
    ...
    def test_contract_is_not_inlined_in_production_entry(self) -> None:
        ...
        self.assertNotIn('    "zg361pp.155": {', production_source)
