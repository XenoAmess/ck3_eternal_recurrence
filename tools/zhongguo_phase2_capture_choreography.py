...
PHASE2_CAPTURE_SCENARIOS: Final = (
    ...
    Phase2CaptureScenario(
        ...
        "the player manager's real B1 publication reaches visible zg361mg.120 and F terminal",
    ),
    Phase2CaptureScenario(
        ...
        ("all_under_heaven", "merit_admin"),
        ("All Under Heaven",),
        ("zg361pp.147", "zg361pp.148"),
        (
            "event_window:zg361pp.147",
            "event_window:zg361pp.148",
        ),
        (
            "query-current-event-window-context-v1",
        ),
        ("select-event-option-N",),
        "the promotion choice reaches its exact D+1 successor for the same played owner and saved subject; AF5 compensation remains an independent accepted gate",
    ),
    Phase2CaptureScenario(
        "phase2_hc_workforce",
        "hc-workforce",
