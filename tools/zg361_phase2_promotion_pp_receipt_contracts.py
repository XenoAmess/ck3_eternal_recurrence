#!/usr/bin/env python3
"""Exact PP delivery-receipt timeline interrupt contracts."""
...
_PP_RECEIPT_SAVED_SCOPE_NAMES: Final = (
...
_PP_RECEIPT_CHARACTER_SCOPES: Final = {
...
PP_RECEIPT_TIMELINE_CONTRACTS: Final[dict[str, dict[str, object]]] = {
    "zg361pp.151": {
        # R207 reached T-domain stage 02's delivery/appeal receipt prompt.
        # Routes 1/2 record an operation, reserve or settle both capacity
        # ledgers, and open the subject acknowledgement/appeal lifecycle.
        # Route 3 skips those business/resource mutations, records only the
        # explicit policy debt, consumes this prompt, and advances the tree.
        "date_raw": 53186904,
        "date_policy": "product-observation-window",
        "root_character_id": 32904,
        "character_scopes": _PP_RECEIPT_CHARACTER_SCOPES,
        "scope_types": {
            name: "value"
            for name in _PP_RECEIPT_SAVED_SCOPE_NAMES
            if name not in _PP_RECEIPT_CHARACTER_SCOPES
        },
        "saved_scope_name_sets": (_PP_RECEIPT_SAVED_SCOPE_NAMES,),
        "boolean_scopes": (),
        "option_count": 3,
