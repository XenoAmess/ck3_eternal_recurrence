...
REQUIRED_MARKERS = (
    ...
    "RQA: TEST PASS phase4_offer_vassalization_paths_valid",
    "RQA: TEST PASS phase4_two_released_rulers_refused_immediate_vassalization",
...
def fixture_errors() -> list[str]:
    ...
    for token in (
        ...
        "phase4_offer_vassalization_paths_valid",
        "phase4_two_released_rulers_refused_immediate_vassalization",
