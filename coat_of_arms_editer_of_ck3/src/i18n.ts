...
const en: Record<MessageKey, string> = {
  ...
  fitPlane: 'Canonical shield preview (same as editor)', fitResultAlt: 'Image-fit result', totalLoss: 'Total loss', colorLoss: 'Color', edgeLoss: 'Edges', candidates: 'Candidates',
