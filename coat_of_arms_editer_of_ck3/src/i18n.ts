...
const zhCN = {
  ...
  checkpointReady: '安全 checkpoint：{lane} · 原生块游标 {completed}/{total}；仅保存在当前标签页',
...
const en: Record<MessageKey, string> = {
  ...
  runStatus: 'Run status', progressStageNote: ' (progress is for the current search stage)', checkpointReady: 'Safe checkpoint: {lane} · native-tile cursor {completed}/{total}; kept in this tab only', pruneProgress: 'Prune pass {pass} · {completed}/{total} · {candidates} candidates evaluated',
