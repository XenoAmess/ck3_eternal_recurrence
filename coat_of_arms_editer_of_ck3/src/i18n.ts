...
const en: Record<MessageKey, string> = {
  ...
  startLocalFit: 'Start local fit', pauseFit: 'Pause', resumeFit: 'Resume', cancel: 'Cancel', compressBlocks: 'Safely merge adjacent equal-style blocks', exactPrune: 'Zero-regression fixed-point prune', cancelPrune: 'Cancel pruning',
