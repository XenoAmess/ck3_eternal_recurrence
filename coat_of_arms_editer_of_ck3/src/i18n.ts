...
const zhCN = {
  ...
  parentPreviewBoundary: '当前纹章引用了 parent = {parent}。浏览器尚未解析该继承对象：代码会完整保留和导出，但上方预览不包含 parent 继承的图案，不得用它判定最终 CK3 外观。',
...
const en: Record<MessageKey, string> = {
  ...
  parentPreviewBoundary: 'This coat of arms references parent = {parent}. The browser does not yet resolve that inherited object. The code is preserved and exported in full, but the preview above omits the parent composition and must not be used as the final CK3 appearance.',
