...
If you thought becoming a duke meant tea, marriage, and waiting for inheritance, you clearly have not received this quarter's review notice.
...
规则先说清：所有天朝制公爵及以上领主，都要给自己的直属官员做考核，不只皇帝。

**English subtitle**

First, the reporting line: every celestial-government duke or higher rates their own direct officials, not just the emperor.

**2. 中文配音 / 主字幕**

伯爵和男爵也别高兴太早。他们不能考核别人，但会被上司考核；没有打分权，不代表没有被打分权。

**English subtitle**

Counts and barons cannot rate anyone, but their superior still rates them. No management authority does not mean freedom from management.
...
状态：`captured` / `TARGET LIVE SHOT · 23 PERSONS / 7-14-2; THE OLD 7-16-0 STILL IS RED AND MUST BE RECAPTURED`
...
排名采用固定序位，平分也不会全员并列第一、集体冲进3.75。毕竟真正的大厂从不允许数学破坏组织目标。

**English subtitle**

Ranks use a stable unique order. A tie cannot make everyone number one and flood 3.75, because mathematics must never obstruct an organizational target.

**3. 中文配音 / 主字幕**

23 个人，七个 3.75、十四个 3.5、两个 3.25。系统第一次建账也不许全员冒充新人：这个 C，今天必须有人背。

**English subtitle**

Twenty-three officials: seven at 3.75, fourteen at 3.5, and two at 3.25. Initial setup is no excuse for making everyone a newcomer; someone must own the C today.
...
Jingcha is a periodic semi-mandatory activity and costs nothing to hold. Reviewing subordinates is not a leadership hobby; it is the job description.

**2. 中文配音 / 主字幕**

玩家当然可以说不。自由一直都在，只是你的直属上司也会自由地降低好感，并把拒办写进下一次绩效理由。

**English subtitle**

The player may refuse. Freedom remains, while the direct superior remains free to lose opinion and record refusal as a major reason in the next review.
...
## 02:46–03:21 · 考核榜与告身：终于有人告诉你到底排第几
...
The scoreboard is not a disposable toast. Each cycle freezes the official, office, KPI, values, rank, grade, streak, and follow-up state.

**2. 中文配音 / 主字幕**

你主持考核时看整张团队榜；你被上司考核时收到独立告身，直接写明上司是谁、你拿多少分、同组第几、绩效几档。

**English subtitle**

Managers see the full team board. When your superior rates you, a separate receipt names the superior, your score, cohort rank, and grade.
...
## 03:21–03:54 · 3.25不是表情包：国库、金币、贤能、俸禄一起有感觉
...
Grades need resource consequences. A 3.75 opens reward and promotion lanes, 3.5 keeps the normal cadence, and 3.25 starts a real improvement cost.
...
## 03:54–04:11 · PIP与末位：给你改进机会，也给上司腾椅子的机会
...
## 04:11–04:32 · 晋升包与HC：它们是政策卡，不是许愿池
...
## 04:32–04:52 · 跨部门抢功：先把它写进制度，而不是编一个项目管理器
...
## 04:52–05:19 · 绩效申诉：不是掀桌，是要求把桌上的账重新加一遍
...
A reversal updates the scoreboard, streak, and exact penalty. Review may maintain or reduce the decision; it cannot punish you merely for appealing.
...
## 05:54–06:22 · 一轮真实玩法：京察、KPI、校准、发榜、兑现
...
## 06:42–07:13 · 来吧，给天下打分——然后等天下给你打分
...
You may lead with evidence and protection, or grind everyone down until only beautiful reports remain. Both paths exist, and the ledger remembers both.

**2. 中文配音 / 主字幕**

《天朝特色361制官员绩效考核》：请开始管理你的直属官员，并准备好在上司面前解释，为什么你的管理方式符合预期。

**English subtitle**

ZhongGuo 361 Style: begin managing your direct officials, then prepare to explain to your superior why your management style meets expectations.
...
May you earn 3.75 every year. Whether the quota allows it is not my problem; that belongs to the next calibration meeting.
