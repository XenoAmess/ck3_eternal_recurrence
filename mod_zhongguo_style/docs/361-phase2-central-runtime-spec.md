...
- Central effect 已按用途投影为 10 个 whole-file shard，顶层定义数依次为
  ...
  顺序和定义集合一致；冻结聚合为 137,077 bytes，SHA-256
  `531743D7A826D04C84FA92600B1D7C682A637925B77E1B52424152874D0E3A3D`。
- Central event 已拆为三个用途 shard：
  ...
  与冻结聚合逐字节、顺序和定义集合一致；冻结聚合为 20,677 bytes，SHA-256
  `1D031B61A549448404F3D197A4F48646852F97CA4C02F0093AD568C8C00704F0`。
