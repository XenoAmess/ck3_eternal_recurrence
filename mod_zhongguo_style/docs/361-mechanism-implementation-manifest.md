...
| 087 | 薪酬区间与区间内位置 | L | P1 | `compensation` | `zg361m.87` | `zg361_mechanism_087_ai_effect` | 2 | complete | fixture-live | fixture-live | contract-complete | partial | partial | `central-wired` |
...
| 112 | 留任访谈 | O | P1 | `organization` | `zg361m.112` | `zg361_mechanism_112_ai_effect` | 2 | complete | fixture-live | fixture-live | contract-complete | partial | partial | `central-wired` |
...
| 114 | 经理育才功绩 | P | P1 | `organization` | `zg361m.114` | `zg361_mechanism_114_ai_effect` | 2 | complete | fixture-live | fixture-live | contract-complete | partial | partial | `central-wired` |
...
| 141 | 高层保荐与否决名单 | S | P2 | `governance` | `zg361m.141` | `zg361_mechanism_141_ai_effect` | 1 | complete | fixture-live | fixture-live | contract-complete | partial | partial | `central-wired` |
...
| 143 | 截止后重大事件的对称处理 | S | P1 | `governance` | `zg361m.143` | `zg361_mechanism_143_ai_effect` | 1 | complete | fixture-live | fixture-live | contract-complete | partial | partial | `central-wired` |
...
| 145 | 同档内的影子排序 | S | P2 | `assessment` | `zg361m.145` | `zg361_mechanism_145_ai_effect` | 1 | complete | fixture-live | fixture-live | contract-complete | partial | partial | `central-wired` |
...
| 154 | 逐项完整纪要 / 摘要纪要 | T | P2 | `governance` | `zg361m.154` | `zg361_mechanism_154_ai_effect` | 1 | complete | fixture-live | fixture-live | contract-complete | partial | partial | `central-wired` |
...
| 172 | 评委投票规则 | V | P2 | `governance` | `zg361m.172` | `zg361_mechanism_172_ai_effect` | 1 | complete | fixture-live | fixture-live | contract-complete | partial | partial | `central-wired` |
...
| 181 | 能力、意愿、目标与岗职四向诊断 | W | P1 | `pip` | `zg361m.181` | `zg361_mechanism_181_ai_effect` | 1 | complete | fixture-live | fixture-live | contract-complete | partial | partial | `central-wired` |
...
| 192 | 能力分层急务轮值 | X | P1 | `incident` | `zg361m.192` | `zg361_mechanism_192_ai_effect` | 1 | complete | fixture-live | fixture-live | contract-complete | partial | partial | `central-wired` |
| 193 | 值守补偿办法 | X | P1 | `compensation` | `zg361m.193` | `zg361_mechanism_193_ai_effect` | 1 | complete | fixture-live | fixture-live | contract-complete | partial | partial | `central-wired` |
...
| 205 | 重复运维工时比例上限 | Y | P1 | `technology` | `zg361m.205` | `zg361_mechanism_205_ai_effect` | 3 | complete | fixture-live | fixture-live | contract-complete | partial | partial | `central-wired` |
...
| 215 | 退役旧系统也算交付 | Y | P1 | `technology` | `zg361m.215` | `zg361_mechanism_215_ai_effect` | 3 | complete | fixture-live | fixture-live | contract-complete | partial | partial | `central-wired` |
...
| 228 | 共享平台事故的波及范围与责任 | Z | P1 | `platform` | `zg361m.228` | `zg361_mechanism_228_ai_effect` | 3 | complete | fixture-live | fixture-live | contract-complete | partial | partial | `central-wired` |
...
| 274 | 候选人还价与竞价上限 | AD | P1 | `compensation` | `zg361m.274` | `zg361_mechanism_274_ai_effect` | 2 | complete | fixture-live | fixture-live | contract-complete | partial | partial | `central-wired` |
...
| 283 | 只升职责、不加俸的兑现期限 | AE | P1 | `compensation` | `zg361m.283` | `zg361_mechanism_283_ai_effect` | 2 | complete | fixture-live | fixture-live | contract-complete | partial | partial | `central-wired` |
| 284 | 降级后的薪俸分段递减 | AE | P1 | `compensation` | `zg361m.284` | `zg361_mechanism_284_ai_effect` | 2 | complete | fixture-live | fixture-live | contract-complete | partial | partial | `central-wired` |
...
| 286 | 高于薪俸上限时冻结、低于下限时追补 | AE | P1 | `compensation` | `zg361m.286` | `zg361_mechanism_286_ai_effect` | 2 | complete | fixture-live | fixture-live | contract-complete | partial | partial | `central-wired` |
| 287 | 薪酬保密、职级薪俸区间公开与匿名分布 | AE | P2 | `governance` | `zg361m.287` | `zg361_mechanism_287_ai_effect` | 2 | complete | fixture-live | fixture-live | contract-complete | partial | partial | `central-wired` |
...
| 304 | 项目与职能的双重管理 | AG | P1 | `organization` | `zg361m.304` | `zg361_mechanism_304_ai_effect` | 2 | complete | fixture-live | fixture-live | contract-complete | partial | partial | `central-wired` |
...
| 306 | 临时代管两组时的精力与目标拆分 | AG | P1 | `organization` | `zg361m.306` | `zg361_mechanism_306_ai_effect` | 2 | complete | fixture-live | fixture-live | contract-complete | partial | partial | `central-wired` |
...
| 316 | 转岗薪酬区间衔接 | AH | P1 | `compensation` | `zg361m.316` | `zg361_mechanism_316_ai_effect` | 2 | complete | fixture-live | fixture-live | contract-complete | partial | partial | `central-wired` |
...
| 318 | 转岗申请频次与名额占用 | AH | P2 | `organization` | `zg361m.318` | `zg361_mechanism_318_ai_effect` | 2 | complete | fixture-live | fixture-live | contract-complete | partial | partial | `central-wired` |
| 319 | 原团队仅可提出一次挽留方案 | AH | P1 | `organization` | `zg361m.319` | `zg361_mechanism_319_ai_effect` | 2 | complete | fixture-live | fixture-live | contract-complete | partial | partial | `central-wired` |
...
| 324 | 结课、应用与业务结果三阶段 | AI | P1 | `learning` | `zg361m.324` | `zg361_mechanism_324_ai_effect` | 2 | complete | fixture-live | fixture-live | contract-complete | partial | partial | `central-wired` |
...
| 330 | 衰退业务人员转训 | AI | P1 | `learning` | `zg361m.330` | `zg361_mechanism_330_ai_effect` | 2 | complete | fixture-live | fixture-live | contract-complete | partial | partial | `central-wired` |
...
| 333 | 高价培训的留任与返还约定 | AI | P2 | `learning` | `zg361m.333` | `zg361_mechanism_333_ai_effect` | 2 | complete | fixture-live | fixture-live | contract-complete | partial | partial | `central-wired` |
...
| 336 | 需求受理门槛 | AJ | P1 | `delivery` | `zg361m.336` | `zg361_mechanism_336_ai_effect` | 3 | complete | fixture-live | fixture-live | contract-complete | partial | partial | `central-wired` |
...
| 347 | 经理人工调整额度 | AK | P1 | `calibration` | `zg361m.347` | `zg361_mechanism_347_ai_effect` | 3 | complete | fixture-live | fixture-live | contract-complete | partial | partial | `central-wired` |
...
| 355 | 高绩效者的目标自动加码 | AL | P1 | `endgame` | `zg361m.355` | `zg361_mechanism_355_ai_effect` | 4 | complete | fixture-live | fixture-live | contract-complete | partial | partial | `central-wired` |
...
| 359 | 翻案后的名额返还与重新送达 | AL | P1 | `calibration` | `zg361m.359` | `zg361_mechanism_359_ai_effect` | 4 | complete | fixture-live | fixture-live | contract-complete | partial | partial | `central-wired` |
...
Manifest semantic SHA-256: `53762d86610302792a0c18c02fc89ed9ee8dc9b2a0d643db9fd4331862b25817`
