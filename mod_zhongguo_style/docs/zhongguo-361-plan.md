...
- **新人保护**：没有上轮 merit 快照者仍参加首次考核并出现在榜单，可得 3.75/3.5，但不进入本轮 3.25 候选；末位名额顺延给排名最靠后的旧官，旧官不足时允许缺额。
...
10. 新增“首轮试用期”语义：无 merit 快照的官员正常参评、可得 3.75/3.5，但免于被强制分布为 3.25；同轮写入快照供下次计算成长。
