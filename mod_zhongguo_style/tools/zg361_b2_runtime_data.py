...
B2_BINDINGS: Final[tuple[B2Binding, ...]] = (
    ...
    _b(15, "绩效改进任务书", "C", "result_delivered", "result_served", "case_open",
    ...
    _b(154, "逐项完整纪要 / 摘要纪要", "T", "feedback_receipt_due", "receipt_recorded", "actions_open",
    ...
    _b(181, "能力、意愿、目标与岗职四向诊断", "W", "pip_triaged", "triaged", "evidence_met",
    ...
    _b(359, "翻案后的名额返还与重新送达", "AL", "appeal_quota_returned", "appeal_returned", "collective_action",
