...
def row_gui(prefix: str, slot: int) -> list[str]:
    ...
    return [
        ...
        "\t\tspacing = 8",
        "\t\tmargin = { 8 4 }",
        f"\t\ttext_single = {{ min_width = 50 max_width = 50 text = \"[GetPlayer.MakeScope.Var('{slot_var('rank')}').GetValue|0]\" default_format = \"#high\" align = center|nobaseline using = Font_Size_Medium }}",
        "\t\tportrait_head_small = {}",
        "\t\tvbox = {",
        ...
        f"\t\ttext_single = {{ min_width = 125 max_width = 125 text = \"[GetPlayer.MakeScope.Var('{slot_var('grade')}').GetValue|2]\" default_format = \"#high\" align = center|nobaseline using = Font_Size_Medium }}",
