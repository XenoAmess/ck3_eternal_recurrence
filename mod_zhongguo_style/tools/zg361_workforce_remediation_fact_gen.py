...
ENGLISH = {
    ...
    "desc": (
        "The file shows that [zg361_workforce_remediation_fact_ticket_subject.GetShortUIName] refused the offer yesterday. "
...
CHINESE = {
    "title": "遭拒的编制仍在冻结",
    "desc": (
        "案卷显示，[zg361_workforce_remediation_fact_ticket_subject.GetShortUIName] 昨日拒绝了录用。"
...
状态：`{READINESS}`。本包只负责旧 Workforce #275-B remediation 两字段债务；本包自身不拥有 Workforce core、#360、runner、CK3 1.19.0.6 bridge/provider 或共享 external-producer ledger。master 的 Workforce core 已在独立集成提交中调用本包公开 ABI，但尚无 loader/paused/live 证据。
