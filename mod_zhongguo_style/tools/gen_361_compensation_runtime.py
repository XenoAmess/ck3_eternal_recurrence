...
def render_english_localization() -> bytes:
 ...
 zg361comp.1.l3.r2:0 "Grant authority to [ROOT.Var('zg361_comp_portfolio_subject').Char.GetShortUIName] now at the above-band rate; add 0 to pay and create no payment deadline."
 ...
 zg361comp.1.ae4.r3:0 "Grant [ROOT.Var('zg361_comp_portfolio_subject').Char.GetShortUIName] a one-cycle band exception; add and pay 0, and publish only the anonymous distribution."
 ...
 zg361comp.1.af4.r1:0 "Split [ROOT.Var('zg361_comp_portfolio_subject').Char.GetShortUIName]'s units 50/50; both portions vest together. After the first vesting, submit departure classification; move 0 cash."
...
def render_simp_chinese_localization() -> bytes:
 ...
 zg361comp.1.l3.r2:0 "现在按带上待遇授予 [ROOT.Var('zg361_comp_portfolio_subject').Char.GetShortUIName] 相应权责；俸额增加为零，不设付款期限。"
 ...
 zg361comp.1.ae4.r3:0 "现在准许 [ROOT.Var('zg361_comp_portfolio_subject').Char.GetShortUIName] 带外例外一轮；新增与支付均为零，只公布匿名分布。"
 ...
 zg361comp.1.af4.r1:0 "为 [ROOT.Var('zg361_comp_portfolio_subject').Char.GetShortUIName] 服务、绩效各记五成；每个归属日两者同归。首次归属后报离任分类，现金为零。"
