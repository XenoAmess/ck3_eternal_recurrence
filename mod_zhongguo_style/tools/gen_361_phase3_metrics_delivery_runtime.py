...
MECHANISMS = (
    ...
    m(237, "aa", 3, "window_audit", "The Most Beautiful Time Window", "截最美的一段",
      ...
      "按预注册的三百六十五日完整时间窗结算。", "并列公开三百六十五日完整窗与九十日精选窗。", "允许截取，但挂上审计标记。"),
    ...
    m(239, "aa", 5, "learning_credit", "A Failed Experiment Still Learned", "实验失败，学习不能归零",
      ...
      "给预注册且可复用的学习证据七成功劳；业务交付仍记失败。", "给学习证据四成功劳，并与失败的业务交付分账。", "只入知识库，不计绩效分。"),
    ...
    m(310, "ag", 4, "legacy_rating_map", "Old Ratings, New Org", "旧档怎么搬进新组织",
      "The reporting line has changed, but historical authorship remains with the former owner. The old file does not yet identify both that owner and the successor now responsible.",
      "汇报线已经变更，旧案仍归原责任人名下；归档记录尚未同时标明原责任人与接任者。",
      "Keep the old case under the former owner.", "Create a transfer record naming both former owner and successor.", "Keep the old case separate for one cycle.",
      "旧案仍归原责任人名下。", "另立交接记录，同时列明原责任人与接任者。", "旧案独立保留一个周期。"),
