...
# Rebuild the manager-owned list through the engine's Character-safe
# `is_alive = yes` filter before the first delayed consumer reads any case
# field. The removed entry is a real review vacancy and must leave the same
