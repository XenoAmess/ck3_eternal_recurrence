...
l_english:
 ...
 zg361b1.126.desc:0 "The board now shows your final rating. Other pending cases no longer hold yours back; this is revision [ROOT.Char.MakeScope.Var('zg361_b1_local_publish_revision').GetValue|0] of your case. Rewards and penalties will still be applied at formal settlement, and no other official's pending case is disclosed here."
...
l_simp_chinese:
 ...
 zg361b1.126.desc:0 "榜上已经列出你的最终档位。即使同组还有待决案卷，你的结果也不再延后；这是本案第 [ROOT.Char.MakeScope.Var('zg361_b1_local_publish_revision').GetValue|0] 次定稿。奖惩仍按正式结算时间入账，其他官员的待定内容不会在这里公开。"
