...
l_english:
 ...
 zg361b2.40.desc:0 "Official: [ROOT.Char.GetShortUIName]. Manager: [ROOT.MakeScope.Var('zg361_b2_pip_owner').Char.GetShortUIName]. The review file contains at least three adverse evidence components. A 365-day improvement period is ready to begin, with a midpoint check on day 180. The single controllable task in this file is:"
 ...
 zg361b2.50.desc:0 "Appellant: [ROOT.Char.GetShortUIName]. Case owner: [ROOT.MakeScope.Var('zg361_b2_case_owner').Char.GetShortUIName]. The review rejected this appeal, so the original result and its posted settlement remain in force. The frozen record reviewed was:"
 ...
 zg361b2.60.desc:0 "A funded voluntary departure agreement has arrived. [ROOT.MakeScope.Var('zg361_b2_case_owner').Char.GetShortUIName] is responsible for its treasury payment; the agreement does not alter the rejected appeal or rewrite its evidence."
 ...
 zg361b2.110.desc:0 "Official: [ROOT.Char.GetShortUIName]. Manager: [ROOT.MakeScope.Var('zg361_b2_pip_owner').Char.GetShortUIName]. The 365-day improvement period closed without graduation. The manager has placed four negotiated dispositions before you; none takes effect without your acceptance, and an active appeal safeguard still suspends execution."
 ...
 zg361b2.131.desc:0 "Official: [ROOT.Char.GetShortUIName]. Case owner: [ROOT.MakeScope.Var('zg361_b2_redelivery_owner').Char.GetShortUIName]. A corrected appeal moved the quota boundary and selected this official as the replacement boundary case. This new notice has its own receipt and 90-day challenge window; it does not borrow the old appeal."
 ...
 zg361b2.160.desc:0 "Official: [ROOT.Char.GetShortUIName]. Case owner: [ROOT.MakeScope.Var('zg361_b2_separate_notice_owner').Char.GetShortUIName]. A later 3.25 result was frozen after the earlier appeal, so this notice cannot borrow that old case or its ruling. The new record is:"
...
l_simp_chinese:
 ...
 zg361b2.40.desc:0 "受评官员：[ROOT.Char.GetShortUIName]；直属上司：[ROOT.MakeScope.Var('zg361_b2_pip_owner').Char.GetShortUIName]。考绩案卷已有至少三项负向证据。一份为期 365 日的改进期正待开始，第 180 日复核中期进展。卷内只列一项本人能够改变的任务："
 ...
 zg361b2.50.desc:0 "申诉人：[ROOT.Char.GetShortUIName]；案卷责任人：[ROOT.MakeScope.Var('zg361_b2_case_owner').Char.GetShortUIName]。复核已经驳回本次申诉，原结果与已入账的清算继续生效。复核所据的冻结记录如下："
 ...
 zg361b2.60.t:0 "中性离任"
 zg361b2.60.desc:0 "一份已有资金保障的自愿离任文书送到了你手中。[ROOT.MakeScope.Var('zg361_b2_case_owner').Char.GetShortUIName]负责从国库出资；这份文书不会改变被驳回的申诉，也不会改写原有证据。"
 zg361b2.60.a:0 "接受：卸任，由责任人国库支出 50，你本人恰好收到 50 金币。"
 zg361b2.60.b:0 "留下，继续走普通程序。"
 zg361b2.110.t:0 "改进期处置"
 zg361b2.110.desc:0 "受评官员：[ROOT.Char.GetShortUIName]；直属上司：[ROOT.MakeScope.Var('zg361_b2_pip_owner').Char.GetShortUIName]。365 日改进期已经结束，但尚未达到结案标准。上司把四份可协商的处置书摆在你面前；未经你接受便不能生效，仍在生效的申诉保护也会继续暂缓执行。"
 ...
 zg361b2.131.desc:0 "受评官员：[ROOT.Char.GetShortUIName]；案卷责任人：[ROOT.MakeScope.Var('zg361_b2_redelivery_owner').Char.GetShortUIName]。申诉改判移动了配额边界，并把你选为新的边界个案。这份通知拥有独立回执与 90 日异议窗口，不会借用旧申诉。"
 ...
 zg361b2.160.desc:0 "受评官员：[ROOT.Char.GetShortUIName]；案卷责任人：[ROOT.MakeScope.Var('zg361_b2_separate_notice_owner').Char.GetShortUIName]。旧申诉结束后，后续考核又冻结了一次 3.25 结果，因此本通知不能借用旧案及其裁决。新记录如下："
