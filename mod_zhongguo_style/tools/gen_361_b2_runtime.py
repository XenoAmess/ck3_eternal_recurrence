...
l_english:
 ...
 zg361b2.50.desc:0 "Appellant: [ROOT.Char.GetShortUIName]. Case owner: [ROOT.Var('zg361_b2_case_owner').Char.GetShortUIName]. The review rejected this appeal, so the original result and its posted settlement remain in force. The frozen record reviewed was:"
...
l_simp_chinese:
 ...
 zg361b2.50.desc:0 "申诉人：[ROOT.Char.GetShortUIName]；案卷责任人：[ROOT.Var('zg361_b2_case_owner').Char.GetShortUIName]。复核已经驳回本次申诉，原结果与已入账的清算继续生效。复核所据的冻结记录如下："
