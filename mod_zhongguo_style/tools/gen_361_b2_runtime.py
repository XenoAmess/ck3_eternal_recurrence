		...
		if = {
			...
			if = {
				limit = {
					age >= 60
					trigger_if = {
						limit = { has_variable = zg361_b2_m074_redundancy_eligible }
...
zg361_b2_consume_pip_performance_evidence_effect = {
	if = {
		...
		if = {
			...
			set_variable = { name = zg361_b2_pip_performance_evidence_consumed_cycle value = root.var:zg361_b1_manager_cycle_serial }
		}
...
l_english:
 ...
 zg361b2.40.desc:0 "Official: [ROOT.Char.GetShortUIName]. Manager: [ROOT.Var('zg361_b2_pip_owner').Char.GetShortUIName]. The review file contains at least three adverse evidence components. A 365-day improvement period is ready to begin, with a midpoint check on day 180. The single controllable task in this file is:"
 ...
 zg361b2.50.t:0 "Final Evidence after an Appeal Is Rejected"
 zg361b2.50.desc:0 "Appellant: [ROOT.Char.GetShortUIName]. Case owner: [ROOT.Var('zg361_b2_case_owner').Char.GetShortUIName]. The original result and its posted settlement remain in force, and both private discussion and formal appeal are exhausted. Any further allegation must be tied to the following frozen record; an unsupported claim will not reopen the rating:"
 zg361b2.50.grade.375:0 "Final band 3.75; frozen KPI [ROOT.Var('zg361_result_kpi_frozen').GetValue|0]; cohort rank [ROOT.Var('zg361_result_rank_frozen').GetValue|0] of [ROOT.Var('zg361_result_cohort_n_frozen').GetValue|0]."
 zg361b2.50.grade.350:0 "Final band 3.50; frozen KPI [ROOT.Var('zg361_result_kpi_frozen').GetValue|0]; cohort rank [ROOT.Var('zg361_result_rank_frozen').GetValue|0] of [ROOT.Var('zg361_result_cohort_n_frozen').GetValue|0]."
 zg361b2.50.grade.325:0 "Final band 3.25; frozen KPI [ROOT.Var('zg361_result_kpi_frozen').GetValue|0]; cohort rank [ROOT.Var('zg361_result_rank_frozen').GetValue|0] of [ROOT.Var('zg361_result_cohort_n_frozen').GetValue|0]."
 ...
 zg361b2.50.a:0 "Publish the evidence packet: lose 50 prestige and open a 30-day fact check; immediate publication also costs the case owner 25 prestige."
 ...
 zg361b2.131.desc:0 "Official: [ROOT.Char.GetShortUIName]. Case owner: [ROOT.Var('zg361_b2_redelivery_owner').Char.GetShortUIName]. A corrected appeal moved the quota boundary and selected this official as the replacement boundary case. This new notice has its own receipt and 90-day challenge window; it does not borrow the old appeal."
 ...
 zg361b2.160.desc:0 "Official: [ROOT.Char.GetShortUIName]. Case owner: [ROOT.Var('zg361_b2_separate_notice_owner').Char.GetShortUIName]. A later 3.25 result was frozen after the earlier appeal, so this notice cannot borrow that old case or its ruling. The new record is:"
 zg361b2.160.fact:0 "Final band 3.25; KPI [ROOT.Var('zg361_b2_retaliation_new_fact_kpi').GetValue|0]; cohort rank [ROOT.Var('zg361_b2_retaliation_new_fact_rank').GetValue|0] of [ROOT.Var('zg361_b2_retaliation_new_fact_cohort').GetValue|0]; case [ROOT.Var('zg361_b2_retaliation_new_fact_case').GetValue|0]."
 ...
 zg361b2.160.reviewer:0 "Independent reviewer on the file: [ROOT.Var('zg361_b2_separate_reviewer').Char.GetShortUIName]. Eligibility and survival will be checked again when the 90-day review closes."
...
l_simp_chinese:
 ...
 zg361b2.40.desc:0 "受评官员：[ROOT.Char.GetShortUIName]；直属上司：[ROOT.Var('zg361_b2_pip_owner').Char.GetShortUIName]。考绩案卷已有至少三项负向证据。一份为期 365 日的改进期正待开始，第 180 日复核中期进展。卷内只列一项本人能够改变的任务："
 ...
 zg361b2.50.t:0 "申诉驳回后的最后举证"
 zg361b2.50.desc:0 "申诉人：[ROOT.Char.GetShortUIName]；案卷责任人：[ROOT.Var('zg361_b2_case_owner').Char.GetShortUIName]。原结果与已入账的清算继续生效，私下沟通与正式申诉也已用尽。此后提出的任何质疑都必须绑定下列冻结记录；没有证据的指控不会重开定档："
 zg361b2.50.grade.375:0 "最终档位 3.75；冻结绩效指标 [ROOT.Var('zg361_result_kpi_frozen').GetValue|0]；同组位次第 [ROOT.Var('zg361_result_rank_frozen').GetValue|0] 名，共 [ROOT.Var('zg361_result_cohort_n_frozen').GetValue|0] 人。"
 zg361b2.50.grade.350:0 "最终档位 3.50；冻结绩效指标 [ROOT.Var('zg361_result_kpi_frozen').GetValue|0]；同组位次第 [ROOT.Var('zg361_result_rank_frozen').GetValue|0] 名，共 [ROOT.Var('zg361_result_cohort_n_frozen').GetValue|0] 人。"
 zg361b2.50.grade.325:0 "最终档位 3.25；冻结绩效指标 [ROOT.Var('zg361_result_kpi_frozen').GetValue|0]；同组位次第 [ROOT.Var('zg361_result_rank_frozen').GetValue|0] 名，共 [ROOT.Var('zg361_result_cohort_n_frozen').GetValue|0] 人。"
 ...
 zg361b2.50.a:0 "公开证据包：损失 50 威望，30日后核查；立即公开时责任人另损失 25 威望。"
 ...
 zg361b2.131.desc:0 "受评官员：[ROOT.Char.GetShortUIName]；案卷责任人：[ROOT.Var('zg361_b2_redelivery_owner').Char.GetShortUIName]。申诉改判移动了配额边界，并把你选为新的边界个案。这份通知拥有独立回执与 90 日异议窗口，不会借用旧申诉。"
 ...
 zg361b2.160.desc:0 "受评官员：[ROOT.Char.GetShortUIName]；案卷责任人：[ROOT.Var('zg361_b2_separate_notice_owner').Char.GetShortUIName]。旧申诉结束后，后续考核又冻结了一次 3.25 结果，因此本通知不能借用旧案及其裁决。新记录如下："
 zg361b2.160.fact:0 "最终档位 3.25；绩效指标 [ROOT.Var('zg361_b2_retaliation_new_fact_kpi').GetValue|0]；同组位次第 [ROOT.Var('zg361_b2_retaliation_new_fact_rank').GetValue|0] 名，共 [ROOT.Var('zg361_b2_retaliation_new_fact_cohort').GetValue|0] 人；案号 [ROOT.Var('zg361_b2_retaliation_new_fact_case').GetValue|0]。"
 ...
 zg361b2.160.reviewer:0 "案卷登记的独立复核人：[ROOT.Var('zg361_b2_separate_reviewer').Char.GetShortUIName]。90 日期满时会再次核验其存活与回避资格。"
