...
BUTTON_EN = {
    ...
    248: ("Record 3 shortages and deduct 5 manager points", "Keep the target and double manager liability"),
...
DETAIL_OVERRIDE_CN = {
    ...
    (245, 2): "仍记录 5 日未结工时，但不予批准并标为影子加班；不支付补偿",
    (246, 1): "立即支付 15 金币，结清本案登记的 5 日额外工时",
    (247, 2): "动员持续约一年，不设中途复盘或续批；一年后按本案记录复核",
    (248, 1): "记录已连续缺编 3 个周期，经理评价扣 5 分；此次不新增编制，也不调整目标",
    (248, 2): "记录已连续缺编 3 个周期，经理评价扣 10 分；此次不新增编制，也不调整目标",
    ...
    (253, 1): "确认最低职责与申诉修复记录，不记失职；不直接改写绩效档位",
    (253, 2): "拒绝申诉修复并记作失职；不直接改写绩效档位",
