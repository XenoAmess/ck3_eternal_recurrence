...
SCENE_CN = {
    ...
    274: "答复期限将近，[zg361_we_ad_subject.GetShortUIName] 带着另一份报价回来议价，现有方案与公平线之间只剩一次调整空间。[zg361_we_ad_owner.GetShortUIName] 必须决定是否动用金币和正式名额。",
...
SCENE_EN = {
    ...
    274: "As the response deadline approaches, [zg361_we_ad_subject.GetShortUIName] has returned with a competing offer, and only one adjustment remains between the current terms and the fairness line. [zg361_we_ad_owner.GetShortUIName] must decide whether gold and formal headcount can move.",
