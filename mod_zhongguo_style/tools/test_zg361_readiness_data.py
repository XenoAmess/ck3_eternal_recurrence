...
class ReadinessDataTests(unittest.TestCase):
    ...
    def test_latest_product_snapshot_records_r106_without_promoting_ids(self) -> None:
        ...
        self.assertEqual(snapshot.observation_days, 931)
        self.assertEqual(snapshot.native_observations, 265)
        self.assertEqual(len(snapshot.drained_event_keys), 120)
        ...
        self.assertIn("931 游戏日", ledger)
        self.assertIn("265 次 native/MCP 观测", ledger)
