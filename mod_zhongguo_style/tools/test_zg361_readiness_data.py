...
class ReadinessDataTests(unittest.TestCase):
    ...
    def test_latest_product_snapshot_records_r106_without_promoting_ids(self) -> None:
        ...
        self.assertEqual(snapshot.observation_days, 505)
        self.assertEqual(snapshot.native_observations, 168)
        self.assertEqual(len(snapshot.drained_event_keys), 57)
        ...
        self.assertIn("505 游戏日", ledger)
        self.assertIn("168 次 native/MCP 观测", ledger)
