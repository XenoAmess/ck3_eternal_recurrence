...
class CareerLearningCopyTests(unittest.TestCase):
    ...
    def test_subject_buttons_describe_only_the_players_response(self) -> None:
        ...
        self.assertEqual(chinese["zg361_cl_m321_route_b"], "退回名帖：不支六金，终止往来且保留昔日案卷")
        self.assertEqual(chinese["zg361_cl_m333_route_a"], "留下任职至旧约履清，不触发十八金追偿")
    ...
    def test_digest_reports_in_world_matters_not_pipeline_mechanics(self) -> None:
        ...
        self.assertEqual(chinese["zg361_cl_digest_ack"], "收存本轮人才案回执；不新增付款或期限。")
