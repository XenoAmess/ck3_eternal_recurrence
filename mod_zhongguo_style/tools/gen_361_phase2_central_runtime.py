...
def render_localization(language: str, header: str) -> str:
    ...
    if chinese:
        ...
        desc = (
            ...
            "[ROOT.Var('zg361_p2c_success_n').GetValue|0]#! 项；经核对无需另办 "
            "[ROOT.Var('zg361_p2c_na_n').GetValue|0] 项；尚有 "
            "[ROOT.Var('zg361_p2c_red_n').GetValue|0] 项未能办结，其中 "
            "[ROOT.Var('zg361_p2c_external_n').GetValue|0] 项是因为所需案情尚未送达。"
        ...
        desc = (
            ...
            "#high [ROOT.Var('zg361_p2c_success_n').GetValue|0]#! items were completed as planned; "
            "[ROOT.Var('zg361_p2c_na_n').GetValue|0] were confirmed to require no further action; "
            "and [ROOT.Var('zg361_p2c_red_n').GetValue|0] remain unfinished. Of the unfinished matters, "
            "[ROOT.Var('zg361_p2c_external_n').GetValue|0] lacked facts that had not yet arrived. "
