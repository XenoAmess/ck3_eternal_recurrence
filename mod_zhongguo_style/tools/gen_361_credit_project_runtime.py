...
MECHANISMS = (
    ...
    m(68, "j", 4, "portable_history", "History Travels; Authorship Does Not", "履历可携带，历史作者不改写",
      "Transferred official [zg361_cp_j_subject.GetShortUIName] arrives under receiving manager [zg361_cp_j_active_manager.GetShortUIName] with prior ratings and an open PIP still owned by [zg361_cp_j_historical_owner.GetShortUIName]. The receiving team has not decided which history to use as a prior; none may consume current quota or re-own old cases.",
      "调入者[zg361_cp_j_subject.GetShortUIName]带着旧评级与未结绩效改进计划到[zg361_cp_j_active_manager.GetShortUIName]麾下，旧案仍由[zg361_cp_j_historical_owner.GetShortUIName]负责。接收团队尚未确定哪些历史只作先验，它们都不能占用本期名额或改写旧案责任人。",
