...
zg361_mg_refuse_jingcha_exact_effect = {{
	if = {{
		limit = {{
			...
			var:zg361_jingcha_mandate_superior = {{ NOT = {{ this = prev }} }}
		}}
	...
	else_if = {{
		limit = {{
			...
			OR = {{
				...
				var:zg361_jingcha_mandate_superior = {{ this = prev }}
			}}
		}}
		add_prestige = {{
			value = 0
		...
		zg361_clear_jingcha_mandate_effect = yes
		debug_log = "ZG361MG: independent or self-aliased top liege refused Jingcha (-200 prestige, no self-review)"
	}}
...
ENGLISH_LOC = r'''
l_english:
 zg361mg.120.t:0 "This Cycle's Management Finding"
 zg361mg.120.desc:0 "The settled record gives you a manager score of #high [ROOT.Var('zg361_mg_report_manager_score').GetValue|0]#!. Its readable weighted grounds are calibration [ROOT.Var('zg361_mg_reason_calibration').GetValue|0], appeal reversals [ROOT.Var('zg361_mg_reason_appeal').GetValue|0], improvement outcomes [ROOT.Var('zg361_mg_reason_pip').GetValue|0], target delivery [ROOT.Var('zg361_mg_reason_delivery').GetValue|0], staffing use [ROOT.Var('zg361_mg_reason_hc').GetValue|0], and relationship adjustment [ROOT.Var('zg361_mg_reason_relationship_once').GetValue|0]. Together they produce an explanatory total of [ROOT.Var('zg361_mg_report_reason_total').GetValue|0]. A Jingcha refusal, when present, is charged once in the overall score."
 zg361mg.120.desc_score_only:0 "The settled record gives you a manager score of #high [ROOT.Var('zg361_mg_report_manager_score').GetValue|0]#!, but the surviving evidence is not sufficient to provide a reliable breakdown. This cycle therefore records the score without inventing reasons or making a placement judgment; a later complete review may supply the missing explanation."
 zg361mg.120.desc_reasons_only:0 "The surviving record is not sufficient to publish a reliable overall score, but it does support these weighted grounds: calibration [ROOT.Var('zg361_mg_reason_calibration').GetValue|0], appeal reversals [ROOT.Var('zg361_mg_reason_appeal').GetValue|0], improvement outcomes [ROOT.Var('zg361_mg_reason_pip').GetValue|0], target delivery [ROOT.Var('zg361_mg_reason_delivery').GetValue|0], staffing use [ROOT.Var('zg361_mg_reason_hc').GetValue|0], and relationship adjustment [ROOT.Var('zg361_mg_reason_relationship_once').GetValue|0]. Their explanatory total is [ROOT.Var('zg361_mg_report_reason_total').GetValue|0]. No placement judgment is made from this partial record."
 ...
 zg361mg.120.a:0 "Archive this cycle's finding and its surviving grounds."
 zg361mg.220.t:0 "This Cycle's Review of the Assessment Office"
 zg361mg.220.desc:0 "The office reviewed [ROOT.Var('zg361_mg_audit_sample_n').GetValue|0] records this cycle. After forms, meetings, appeals, and calibration work, #high [ROOT.Var('zg361_mg_admin_capacity_remaining').GetValue|0]#! governance capacity remains. The cost of that work will be carried into the next manager review."
...
CHINESE_LOC = r'''
l_simp_chinese:
 zg361mg.120.t:0 "本轮管理评定"
 zg361mg.120.desc:0 "案卷将你的本轮管理总评定为 #high [ROOT.Var('zg361_mg_report_manager_score').GetValue|0]#!。这不是一枚没有来由的数字：校准记录贡献 [ROOT.Var('zg361_mg_reason_calibration').GetValue|0]，申诉改判贡献 [ROOT.Var('zg361_mg_reason_appeal').GetValue|0]，改进成效贡献 [ROOT.Var('zg361_mg_reason_pip').GetValue|0]，任务兑现贡献 [ROOT.Var('zg361_mg_reason_delivery').GetValue|0]，编制运用贡献 [ROOT.Var('zg361_mg_reason_hc').GetValue|0]，上下级关系修正贡献 [ROOT.Var('zg361_mg_reason_relationship_once').GetValue|0]；六项加权说明合计 [ROOT.Var('zg361_mg_report_reason_total').GetValue|0]。若本轮曾拒办京察，该项只在总评中扣除一次。"
 zg361mg.120.desc_score_only:0 "案卷将你的本轮管理总评定为 #high [ROOT.Var('zg361_mg_report_manager_score').GetValue|0]#!，但现存记录不足以拆出可靠依据。本轮只登记分数，不编造理由，也不据此判断任职位置；待下次取得完整复核记录后再补做说明。"
 zg361mg.120.desc_reasons_only:0 "现存记录不足以发布可靠的管理总评，但足以列明已经核对的依据：校准记录贡献 [ROOT.Var('zg361_mg_reason_calibration').GetValue|0]，申诉改判贡献 [ROOT.Var('zg361_mg_reason_appeal').GetValue|0]，改进成效贡献 [ROOT.Var('zg361_mg_reason_pip').GetValue|0]，任务兑现贡献 [ROOT.Var('zg361_mg_reason_delivery').GetValue|0]，编制运用贡献 [ROOT.Var('zg361_mg_reason_hc').GetValue|0]，上下级关系修正贡献 [ROOT.Var('zg361_mg_reason_relationship_once').GetValue|0]；六项加权说明合计 [ROOT.Var('zg361_mg_report_reason_total').GetValue|0]。这份残缺记录不用于判断任职位置。"
 zg361mg.120.desc_unavailable:0 "现存的结案材料太少，既不足以发布管理总评，也不足以列出可信理由。本轮只能如实记作材料不全，不判断任职位置；下次完整复核必须先补齐依据再下结论。"
 zg361mg.120.a:0 "归档本轮评定与现有依据。"
 zg361mg.220.t:0 "官署考核事务复核"
 zg361mg.220.desc:0 "官署本轮复核了 [ROOT.Var('zg361_mg_audit_sample_n').GetValue|0] 份记录。办完表册、例会、申诉和校准事务后，尚余 #high [ROOT.Var('zg361_mg_admin_capacity_remaining').GetValue|0]#! 点治理精力；本轮耗费将在下一次管理者考核中结算。"
