...
- `mod_tributary_expansion_directives/` — “驱策朝贡国 / Tributary Expansion Directives”独立版源目录；正式发布只使用 `build_tributary_expansion_directives_release.py` 生成的 16 文件 staging
...
- 原版 Steam 创意工坊物品 id：**3784706360**；白绮独立版 id：**3787304042**；“肃清曼荼罗伪信”独立版 id：**3797711947**；“XenoAmess的体验优化”独立版 id：**3798133925**；“重整河山”独立版 id：**3798404599**。
