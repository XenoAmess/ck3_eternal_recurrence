...
- **宗教域由项目所有者明确暂缓。** 鉴于 CK3 近期版本将大规模重构宗教系统，在项目所有者明确通知“可以开始宗教相关内容”以前，不得深入探索或实现 faith/doctrine/tenet/fervor、改宗、宗教改革、圣战等宗教专用原生 AI 树、bridge、策略或实机矩阵；通用能力只能保留不影响其他玩法的 opaque 兼容边界。文化、创新、法律、政府和非宗教事件/决议照常推进；暂缓不等于宗教域已完成。
