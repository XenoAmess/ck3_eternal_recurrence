...
struct MainThreadQueryInstallEnvironmentV1 {
  ...
  MainThreadQueryExecutorV1 permitted_executor_octodenary = nullptr;
  MainThreadQueryExecutorV1 permitted_executor_novemdenary = nullptr;
  ...
  MainThreadQueryExecutorV1 permitted_executor_septemvigintary = nullptr;
  ...
  MainThreadQueryExecutorV1 permitted_executor_duotrigintary = nullptr;
  MainThreadQueryExecutorV1 permitted_executor_tritrigintary = nullptr;
  // Shared private executor allocation: 34 faction, 35 construction,
  // 36 decision, 37 law, 38 marriage. Empty reserved slots remain typed and
  ...
  // Fixed slot 39 remains reserved for the scheduled Scheme backend.
  ...
  // Fixed private LIFE2/LIFE4/LIFE6/LIFE7 executor, absent when its opt-in
  // candidate is disabled. This is not an open native-call slot.
  ...
  // Private, read-only M5 five-candidate alliance projection (slot 48).
  ...
  // Default-off managed original battle-day trace begin/finish (slots 51/52).
  MainThreadQueryExecutorV1 permitted_executor_unquinquagintary = nullptr;
  MainThreadQueryExecutorV1 permitted_executor_duoquinquagintary = nullptr;
