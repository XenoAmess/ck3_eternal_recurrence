...
constexpr std::array<std::string_view, kCapabilityCount> kCapabilities{
    ...
    ck3_11906::kZhongguoCompensationAf5SnapshotV1Capability,
#endif
    ...
    ck3_11906::kFrontendGuiCommitDynastyCoatOfArmsV1Capability,
    ck3_11906::kFrontendGuiEnterCoatOfArmsCustomModeV1Capability,
    ck3_11906::kFrontendGuiRandomizeRulerFirstNameV1Capability,
    ck3_11906::kFrontendGuiFinalizeCustomRulerV1Capability,
    ck3_11906::kFrontendGuiConfirmCustomRulerV1Capability,
...
public:
  ...
  bool read_default_raise_province(
      std::int32_t character_id,
      std::int32_t &province_id) const noexcept override {
    return ck3_11906::ReadDefaultRaiseProvince(
        bindings_, character_id, province_id);
  }
