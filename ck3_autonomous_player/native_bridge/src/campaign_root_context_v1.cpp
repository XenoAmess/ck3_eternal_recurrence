...
bool EnvironmentIsExact(
  ...
  return reinterpret_cast<std::uintptr_t>(environment.game_state_slot) ==
         ...
         reinterpret_cast<std::uintptr_t>(
             ...
             base + kCampaignRootProvinceHolderCharacterIdRva &&
         reinterpret_cast<std::uintptr_t>(
...
bool ReadObservation(const CampaignRootNativeEnvironmentV1 &environment,
  ...
  if (!ReadPrimaryTitleSuccession(environment, access, output)) {
  ...
  if (!ReadAdjacentExternalProvinceHolders(environment, access, output)) {
...
CampaignRootNativeEnvironmentV1 BindCampaignRootNativeEnvironmentV1(
  ...
  output.province_holder_character_id = reinterpret_cast<
      NativeCampaignRootProvinceHolderCharacterIdV1>(
      module_base + kCampaignRootProvinceHolderCharacterIdRva);
