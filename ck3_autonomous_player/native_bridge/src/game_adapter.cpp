...
bool GameAdapter::supports_step(std::string_view step) const noexcept {
  ...
  if (step == "pause-map") {
  ...
  } else if (ck3_11906::ParseZhongguoCompensationAf5SnapshotV1Step(step)) {
    capability = ck3_11906::kZhongguoCompensationAf5SnapshotV1Capability;
  } else if (
  ...
  } else if (step == ck3_11906::kFrontendGuiSelectRandomPlayableV1Step) {
    capability =
        ck3_11906::kFrontendGuiSelectRandomPlayableV1Capability;
  } else if (step == ck3_11906::kFrontendGuiOpenRulerDesignerV1Step) {
    capability = ck3_11906::kFrontendGuiOpenRulerDesignerV1Capability;
  } else if (step == ck3_11906::kFrontendGuiOpenCoatOfArmsDesignerV1Step) {
    capability = ck3_11906::kFrontendGuiOpenCoatOfArmsDesignerV1Capability;
  } else if (step == ck3_11906::kFrontendGuiCommitDynastyCoatOfArmsV1Step) {
    capability = ck3_11906::kFrontendGuiCommitDynastyCoatOfArmsV1Capability;
    ...
    capability = ck3_11906::kSetPlayedCharacterV1Capability;
  } else {
