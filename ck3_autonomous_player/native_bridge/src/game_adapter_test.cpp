...
int main() {
  ...
  if (Contains(
          ...
          "game.command.query-zhongguo-career-hc-workforce-postcondition-v1")) {
    return Fail(
        "default adapter advertised unproven career-HC/workforce provider");
  }
#endif
  ...
  if (exact_adapter == nullptr || !exact_adapter->enabled() ||
      ...
      !exact_adapter->supports_step("query-frontend-gui-route-v1") ||
      ...
      !exact_adapter->supports_step(
          "research-arm-tactical-daily-sentinel-v1-53178264-to-"
          "53178288-speed-5-mode-terminal-a-0") ||
      exact_adapter->supports_step(
          "research-arm-tactical-daily-sentinel-v1-53178264-to-"
          "53178288-speed-5-mode-decision-a-0") ||
      !exact_adapter->supports_step(
