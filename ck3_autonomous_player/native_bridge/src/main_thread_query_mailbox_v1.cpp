...
bool InstallMainThreadQueryMailboxV1(
  ...
  if (!environment.offline_fixture &&
      ...
      environment.permitted_executor_trivigintary == nullptr &&
      ...
      environment.permitted_executor_duotrigintary == nullptr &&
      environment.permitted_executor_tritrigintary == nullptr &&
      environment.permitted_executor_quattuortrigintary == nullptr &&
      environment.permitted_executor_quintrigintary == nullptr &&
      environment.permitted_executor_sextrigintary == nullptr &&
      environment.permitted_executor_septentrigintary == nullptr &&
      environment.permitted_executor_octotrigintary == nullptr &&
      environment.permitted_executor_quadragintary == nullptr &&
      environment.permitted_executor_unquadragintary == nullptr &&
      environment.permitted_executor_duoquadragintary == nullptr &&
      environment.permitted_executor_trioquadragintary == nullptr &&
      environment.permitted_executor_quattuorquadragintary == nullptr &&
      environment.permitted_executor_quinquadragintary == nullptr &&
  ...
  mailbox.permitted_executor_duotrigintary =
      environment.permitted_executor_duotrigintary;
  mailbox.permitted_executor_tritrigintary =
  ...
  mailbox.permitted_executor_quattuorquadragintary =
      environment.permitted_executor_quattuorquadragintary;
  mailbox.permitted_executor_quinquadragintary =
      environment.permitted_executor_quinquadragintary;
  mailbox.permitted_executor_sexquadragintary =
      environment.permitted_executor_sexquadragintary;
  mailbox.permitted_executor_septenquadragintary =
  ...
  mailbox.permitted_executor_quinquagintary =
      environment.permitted_executor_quinquagintary;
  mailbox.permitted_executor_unquinquagintary =
...
MainThreadQuerySubmitResultV1 TrySubmitMainThreadQueryV1(
  ...
  if ((mailbox.permitted_executor != nullptr ||
       ...
       mailbox.permitted_executor_trivigintary != nullptr ||
       ...
       mailbox.permitted_executor_duotrigintary != nullptr ||
       mailbox.permitted_executor_tritrigintary != nullptr ||
       mailbox.permitted_executor_quattuortrigintary != nullptr ||
       mailbox.permitted_executor_quintrigintary != nullptr ||
       mailbox.permitted_executor_sextrigintary != nullptr ||
       mailbox.permitted_executor_septentrigintary != nullptr ||
       mailbox.permitted_executor_octotrigintary != nullptr ||
       mailbox.permitted_executor_quadragintary != nullptr ||
       mailbox.permitted_executor_unquadragintary != nullptr ||
       mailbox.permitted_executor_duoquadragintary != nullptr ||
       mailbox.permitted_executor_trioquadragintary != nullptr ||
       mailbox.permitted_executor_quattuorquadragintary != nullptr ||
       mailbox.permitted_executor_quinquadragintary != nullptr ||
      ...
      executor != mailbox.permitted_executor_trivigintary &&
      ...
      executor != mailbox.permitted_executor_duotrigintary &&
      executor != mailbox.permitted_executor_tritrigintary &&
      executor != mailbox.permitted_executor_quattuortrigintary &&
      executor != mailbox.permitted_executor_quintrigintary &&
      executor != mailbox.permitted_executor_sextrigintary &&
      executor != mailbox.permitted_executor_septentrigintary &&
      executor != mailbox.permitted_executor_octotrigintary &&
      executor != mailbox.permitted_executor_quadragintary &&
      executor != mailbox.permitted_executor_unquadragintary &&
      executor != mailbox.permitted_executor_duoquadragintary &&
      executor != mailbox.permitted_executor_trioquadragintary &&
      executor != mailbox.permitted_executor_quattuorquadragintary &&
      executor != mailbox.permitted_executor_quinquadragintary &&
