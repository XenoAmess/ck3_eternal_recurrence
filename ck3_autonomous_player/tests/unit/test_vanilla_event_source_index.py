...
def test_frozen_index_covers_unique_exact_build_definitions_and_candidates() -> None:
    ...
    assert audit == {
        "registered_event_count": 190,
        "unique_definition_count": 190,
        "definition_file_count": 75,
        "missing_definition_count": 0,
        "ambiguous_definition_count": 0,
        "namespace_mismatch_count": 0,
        "caller_candidate_reference_count": 532,
        "external_caller_event_count": 154,
        "same_file_only_caller_event_count": 36,
        "caller_candidate_file_count": 83,
    }
