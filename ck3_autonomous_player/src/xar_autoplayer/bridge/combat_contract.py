    ...
    for side_index, expected_side in enumerate(("attacker", "defender")):
        ...
        row = _exact_object(
            rows[side_index],
            {
                ...
                "ordered_army_ids",
                "supply",
                "primary_army_recently_disembarked_raw",
                "owner_character_id",
        ...
        normalized.append(
            {
                ...
                "primary_army_recently_disembarked_raw": _signed_int32(
                    row.get("primary_army_recently_disembarked_raw"),
                    f"{side_name}.primary_army_recently_disembarked_raw",
                ),
