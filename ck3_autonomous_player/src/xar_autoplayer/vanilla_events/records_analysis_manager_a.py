...
_EXCLUDED_EVENTS: Final = frozenset({"great_holy_war.0011"})
...
_REVIEW_SUMMARY_BY_EVENT: Final[dict[str, str]] = {
    ...
    "epidemic_events.0110": (
        "Native 2 avoids capital relocation, campaign-gold spending and follow-up, "
        "while applying the weaker recovery result."
    ),
    "epidemic_events.5001": (
