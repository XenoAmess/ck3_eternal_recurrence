...
from .records_char_interaction import (
...
from .records_chancellor_foreign_affairs import (
...
DEFAULT_VANILLA_EVENT_ANALYSIS: Final = _merge_metadata_tables(
    ...
    ("tgp_japan_yearly", VANILLA_TGP_JAPAN_YEARLY_ANALYSIS),
    ("tgp_travel", VANILLA_TGP_TRAVEL_ANALYSIS),
    ("pay_homage", VANILLA_PAY_HOMAGE_ANALYSIS),
    ("physician_epidemic", VANILLA_PHYSICIAN_EPIDEMIC_ANALYSIS),
    ("prison_notification", VANILLA_PRISON_NOTIFICATION_ANALYSIS),
    ("tgp_movement", VANILLA_TGP_MOVEMENT_ANALYSIS),
    ("vassal_interaction", VANILLA_VASSAL_INTERACTION_ANALYSIS),
    ("char_interaction", VANILLA_CHAR_INTERACTION_ANALYSIS),
    ("trait_specific", VANILLA_TRAIT_SPECIFIC_ANALYSIS),
    ("death_management", VANILLA_DEATH_MANAGEMENT_ANALYSIS),
    ("chancellor_foreign_affairs", VANILLA_CHANCELLOR_FOREIGN_AFFAIRS_ANALYSIS),
    ("diplomacy_majesty", VANILLA_DIPLOMACY_MAJESTY_ANALYSIS),
    ("faction_demand", VANILLA_FACTION_DEMAND_ANALYSIS),
    ("fervor_event_continuity", VANILLA_FERVOR_ANALYSIS),
