...
from .records_tgp_treasury import VANILLA_TGP_TREASURY_TIMELINE_CONTRACTS
...
# Compatibility export for tools that still use the former manager-b name.
# Canonical ownership is now the campaign-neutral shared treasury record.
