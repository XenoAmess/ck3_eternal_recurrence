...
R0167 Robert ?? paused ????????? `stewardship_wealth_focus`??? XP `2131.25`????? `2`???????????? `cutting_corners_perk`????????????????????????????? perk OODA ? G2-M4 ????????????? `Z:/ck3_mod_rewrite_process_assets/g2-m4-robert-r0167-three-query-green-20260923/R0167-evidence-freeze/R0167-readback-freeze.json`?SHA-256 `AEAB84B6BDD6548685FC89757675CEBB7BD05532EE6AA984CE373B559B9259D3`??

????????? `allow_private_lifestyle_formal_trial=True` ??????? slot43 ????? typed perk ???????????? receipt ????? turn ???`choose_one_life_turn` ?????????????? `life-advance` ?????? perk?????? RED ????????????????? scope ??????????????**??????**???????? perk ?????????????????? focus???????? focus ????? `same_frame_feudal_peace_scope`???????????????????????? OFF?

????????????????????????? paused ???????????????????? typed perk?????? `HasPerk=true` ????? LIFE2 ??????????/???????? turn ???????????? checkpoint??? native receipt ?????????? Python ? receipt ??????????????????????????R0167 ???????????????????????????? G2-M4 ????????
