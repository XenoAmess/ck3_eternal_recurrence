...
**当前预览连续交付：NO-GO（R0072 新 RED，2026-09-22）。** PRV-006 的 [冻结 ZIP](Z:/ck3_mod_rewrite_process_assets/g2-preview-ordinary-cad5518-20260922/release/g2-preview-ordinary-h1662-cad5518-prv006.zip) SHA-256 `7503E5D92703F29EA9BF72009FB24A108EFEE914AE6DDE42BB1135D1A6952803` 与 [外部 GO 收据](Z:/ck3_mod_rewrite_process_assets/g2-preview-ordinary-cad5518-20260922/release/GO-qualification.json) 仍是截至 R0071 的历史有界资格；[当前操作指南与警示](Z:/ck3_mod_rewrite_process_assets/g2-preview-ordinary-cad5518-20260922/START-HERE.md) 优先。随后同包、同 h1662 主链从 R0070 成对 checkpoint 正式续跑 R0072，仅推进 23 游戏日即自然遇 `health.7000` 一选项事件，已注册合同的四项原生投影检查失败，`registered_contract_projection_drift` 真实 RED；零事件动作，最后安全 pair 原样，PID 回收。因此不得把历史 GO 外推成该 checkpoint 后的持续无人值守能力；EVT-B0-R0072 最小原版树/注册合同修复、重新封包并同版实机复验之前暂停预览连续性广告。CK3 exact 1.19.0.6（EXE SHA `2D00FF3101EF70B566F2FCBAE292F09263199C80E9DC8F139B82D7D96F83DB86`）、agent `cad551895476f3612c33915955cf987c6c0fdc18`、包内原始 h1662 标准封建存档、`xar_off`、仅 `mod/xar_autoplayer.mod` 与 DLC 配置均未改变。以下 R888/PRV-005 NO-GO 段落亦为历史快照；CK3 本体不在包内。
