...
- [static-ready complete analysis + five production-live primitives + three retained RED] [vanilla-event-knowledge-registry.md](vanilla-event-knowledge-registry.md)
  已组合默认 `160 contracts / 160 analysis / 8 observation keys` 的 exact-build 原版事件表并发布离线
  ...
  production-live primitive；R374 当前停于 `natural_disaster.7031` instance `978` 动作前 RED，通用合同与 observation 已按
  exact-build 定义和真实四 scope 迁移。
