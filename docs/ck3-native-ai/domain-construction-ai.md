...
R0242 在修复后源码 `913b3d52b27dfcf56252f37a00432699f8e9b73f`、同源 native DLL SHA `CE57BB7F67B3B6646796E9679B5D198557CE175C056000C8FE4DFCB940F2FB0C` 上，从原始 Robert h90 经官方 ordinary `xar_off` 配对/no-launch，启动前分配并以唯一 PID114084 最小化运行，12/12 turn `turn_limit/qualified`、进程树回收。第 2/3 turn正式建设提交/独立 `applied`，第 6 turn同样 raw53153760→53153976（9 天）；与旧 R0240 相比，第 9 turn **没有**过早 `construction_completion_watch`，而是读到已生效的继承人订婚，第 10 turn继续读实际联盟，第 11/12 turn正常战争只读评估。此对照证明有界 9 天窗口内的过早 watch 被移除；它不证明 30 日 watch 或建筑完工/实际收入。[正式报告](Z:/ck3_mod_rewrite_process_assets/g2-robert-construction-watch-h90-c32-20260927/attempt-01/formal-report.txt) SHA `71BBA3E2917609154F29FC37474A14FE6A8292E727562C4612EFEC8C50E4280D`，[operator](Z:/ck3_mod_rewrite_process_assets/g2-robert-construction-watch-h90-c32-20260927/attempt-01/operator-receipt.json) SHA `F9BE16A939F5BE6E9786C6378B4F0B6BFBE5FD51F0B2679893AE65A32463D4C1`，[窗口回执](Z:/ck3_mod_rewrite_process_assets/g2-robert-construction-watch-h90-c32-20260927/attempt-01-window.json) SHA `6D582125E66297BBA754A4BE370C988C427DEAD671EF8D6CC6BF0FE67D2C6EDE`。h107 save SHA `3DFFE87F2EC56258F39A9CB04DC40257119C892D232EC4859702583D94213BC6`、四件配对清单 SHA `A49016C7114F664F447C14730F4E32666A86B019F2355C51656377DDB23BA4D6`；这条派生支线与 C30 的同编号 h107 不是同一存档。
