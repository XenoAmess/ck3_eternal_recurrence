...
## 2026-09-22 R0090–R0092：成对检查点继续，百年正式窗口受环境写入权限阻塞

| Delivery gate / capability | Status | Formal entry | Artifact / source | Actual game and next-turn evidence | Restore evidence | B0/B1 gap / owner | Branch cleanup |
| --- | --- | --- | --- | --- | --- | --- | --- |
| First standard-feudal seed 100-year prefix | R0090 `completed-red` (turn-limit pending decision); R0091 `completed-green` technical only; R0092 no-launch READY, not allocated; 100-year gate OPEN | `g2_preview_operator.py run` / native-auto-run, frozen Python `75dce4c` + native B114, h426 century manifest uses existing 50000-turn/604800s target paused 1166-09-15 | R0090 immutable manifest `D4943F47…6740`; R0091 `B1E71BFA…9F7A`; R0092 no-launch manifest `5003369E…33DA` | R0090 turn20 three-option modal only, no definition/typed event action; R0091 12/12, +98 durable game days, pending modal not recurring, no same-RNG retry; physician material result and G2-M2 still open | R0090 last safe h409/raw53351016/save `593565E5…84230`; R0091 official fresh PID96676 cold bind discarded unpaired tail and produced paired h426/raw53353368 save `FC1DED45…3DE63`/driver `E17D9157…3D2A`; process tree cleaned. R0092 preflight bound h426 but did not launch | Current platform sandbox cannot write canonical external `g2-live-run-ids-v1` ledger, so no safe R0092 round allocation; restore legitimate permission, recheck all managed instances, then run existing frozen century contract. EVT-B0-R0089 private exact named-modifier readback PR #38 static candidate only; independent live material remains RED. /root | #37 `ed5c332`→master `75dce4c`, #35 `b328ecd`→master `e8c6074`, temp refs/worktrees cleaned; #38 `76095e6` PR pending official checks; report branch not yet delivered |

> 本表上行写入时 #38 尚在 CI；随后它已由原 `76095e6` 经单父 rebase 入 protected master `069634c`，official static/CLA GREEN，远端临时分支核验 tip 后删除。查询仍默认 OFF、未实机，R0089 物质 RED 不变；本地原 worktree/branch 因沙箱禁止写 `.git` 元数据而清理阻塞，不能标工程 DONE。

## 2026-09-22 R0118/h1566 战争改道：R0123–R0124 接班结果
...
- R0118 直接原因已收窄：#1307 玩家军队省1684 regular/idle，敌军 45 sieging；#1310 玩家354/原生 power1068500000、敌759/power2075900000；#1311 路线 `[699,700,714,975,715,45]`，#1312 一日 free 只到 raw53370576，目标抵达 raw53371944；#1313 提交 move。`strategy.py` 的 exact objective 候选缺少已用于持有郡 fallback 的压制否决。exact-build 树更新后，聚焦 Python 策略候选拒绝“敌 current 在路线且 operational overmatch”的一日 free，复现返回一日防御 hold，均衡对照仍可移动；3 项聚焦 GREEN。状态仅 `static-ready`，不是已解战争 RED。下一步从 R0108 precommit 物理配对官方准备/重绑并 no-launch，冻结新候选后唯一 CK3 正式重放，独立核验路线/次回合/checkpoint；不能把旧 h1566 日期进度算到回退支线。

## 2026-09-22 R0125 h1120→h1531 生产续跑

| Delivery gate / capability | Status | Formal entry | Artifact / source | Actual game and next-turn evidence | Restore evidence | B0/B1 gap / owner | Branch cleanup |
| --- | --- | --- | --- | --- | --- | --- | --- |
| R0118 unsafe exact-objective route repair, original WarID251658364 | Static fix integrated; original live RED open | PR #85 strategy `82c6703`; official h1120 no-launch + R0125 production operator | R0125 [immutable manifest](Z:/ck3_mod_rewrite/.task-tmp/RUN-001/war-precommit-h1120-master82c6703-nolaunch-20260922/R0125-formal/R0125-evidence-manifest.json) SHA-256 `98C53859DDB29DA591C5C71ED592AF8F48EA19C78AFC43D9EDBFC1EA0CFC39B0` | 250/250, +235 game days, turn178 only typed move to46; next paused frame shows moving to46 while enemy sieges45; following turn consumes. Different WarID301989950; no claim of old same-frame fix | h1531/raw53373912 save `39AE56B8…333F2` / driver `0B4F96CA…8081` paired. R0126 official continuation no-launch GREEN from same pair; read-only h1532–1533 suffix must be officially trimmed | Continue bounded production from valid pair, preserve first new RED. Old h1566 enemy-contact state remains unresolved; do not advance it or blind surrender. `/root` | PR #85 original `540a207` → master `82c6703`, branch/worktree cleaned; runtime source and checkpoint retained |

## 2026-09-22 R0126 h1531→h1955 正式续跑

| Delivery gate / capability | Status | Formal entry | Artifact / source | Actual game and next-turn evidence | Restore evidence | B0/B1 gap / owner | Branch cleanup |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Ordinary first-seed war continuation; original R0118 WarID251658364 RED | R0126 technical production GREEN for different WarID301989950; old RED open | Official h1531 prepare/rebind, cold validator, no-launch; `g2_preview_operator.py run` 250 turns on source `82c6703` | [R0126 manifest](Z:/ck3_mod_rewrite/.task-tmp/RUN-001/war-h1531-continuation-source82c6703-nolaunch-20260922/R0126-execution/R0126-evidence-manifest.json) SHA-256 `FB629F72608E30527B0372CCA720BDFE84C9794C4CB200034E4813EDAB96D93B`; report `931E0C17…4F736` | 250/250, +218 days; turn66 assault at46 started and consumed; turn123 pending vassal-transfer rejected with pending=None; turn140 natural `death_management.1007` native0 event24→null and same-day stress0→20, subsequent turn/date consumed; M2 .1007 exact no-killer natural subgate GREEN; M2 overall in_progress; PR #93 pending integration | h1955/raw53379144 save `F9AFFDF7…ADE96` / driver `E2A13A47…09CE2D` paired, no tail/pending; process tree 0. Next round requires new official no-launch | Preserve original R0118 RED and continue first-seed bounded production; no milestone promotion. `/root` | PR #85 strategy source already on master; R0126 runtime source/checkpoint retained; progress PR #91 `b956edd` cleaned |
## 2026-09-22 R0127 自然待回复 B0 与 h2083 恢复

| Delivery gate / capability | Status | Formal entry | Artifact / source | Actual game and next-turn evidence | Restore evidence | B0/B1 gap / owner | Branch cleanup |
| --- | --- | --- | --- | --- | --- | --- | --- |
| First-seed ordinary continuation; natural `perk_alliance_interaction` | R0127 `completed-red`; new product B0. Original R0118 WarID251658364 RED open | R0126 h1955 official pair → R0127 formal run, frozen source `82c6703`, `ordinary_campaign_succession/xar_off` | [R0127 immutable manifest](Z:/ck3_mod_rewrite/.task-tmp/RUN-001/war-h1955-continuation-source82c6703-nolaunch-20260922/R0127-execution/R0127-evidence-manifest.json) SHA-256 `85CB6D796729D622D3D381B25154AA3457A7B9F88C7CEC8CF05A7F2AD56C2749` | 105/106 turns; turn106/raw53388120 pending `perk_alliance_interaction` instance `-268435437`, `planner_blocked`, 0 reply. WarID301989950 score -100 at turn45 then absent from next-day `war_ids`; turn46 typed disband leaves no army. Material war terms unobserved; no victory/surrender claim | Last durable h2083/raw53386440 save `DF6B61DD…FC26080`; source driver `291DEAD9…8D887` has #2084–2096 13 unpaired rows, incl two `life-advance`. [No-launch restore boundary](Z:/ck3_mod_rewrite/.task-tmp/RUN-001/war-r0127-h2083-restore-boundary-20260922/RESTORE-BOUNDARY-EVIDENCE.json) SHA-256 `F3E6B97C444D1D8B2E478AC02D54F42EB32A63F3EC3A6890D83E1EAB85498C77`; derived driver `F7FE57B9…5EC33DC6`, consumer/cold validator/preflight GREEN, no launch. Formal cold restore must semantically discard tail; no formal candidate frozen | Council agent: exact policy repair for pending definition, then bind its integrated source to a separate candidate and verify one typed reply, independent postcondition, next turn and checkpoint/cold restore. WAR owner: preserve h2083 original and old WarID251658364 RED; no blind surrender or unpaired date accrual. | R0127 runtime and restore artifacts retained; progress branch awaiting integration/cleanup |

## 2026-09-22 R0129 ??????? `great_holy_war.0011` ? B0

| Delivery gate / capability | Status | Formal entry | Artifact / source | Actual game and next-turn evidence | Restore evidence | B0/B1 gap / owner | Branch cleanup |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Exact-shape inbound `perk_alliance_interaction` reply | R0129 `production-live loop` for reply lifecycle only; M5 material alliance terms still open | Frozen `3559c0f`, ordinary/xar_off, R0127 h2083 official prepare/rebind + no-launch GREEN ? R0129 formal | [R0129 immutable manifest](Z:/ck3_mod_rewrite/.task-tmp/RUN-001/war-h2083-continuation-source3559c0f-nolaunch-20260922/R0129-formal/R0129-evidence-manifest.json) SHA-256 `576D47C357504D168D7A638F4268B2100D7BD596BE4245B224806BB42731CC8C`; report `2707E485?AE2F` | turn16 same-frame context; turn17 sender31506?recipient36403 instance `-1023410161` sole typed accept returned accepted, independent paused pending=null; turn18 before pending=null. No semantic alliance relation/terms readback. | h2105 after reply, later h2124 and h2145 checkpoints recorded; current h2145/raw53392392 paired save `AA5D2294?FCE807`; driver `3B20E68C?163E03` has #2146?2152 unpaired tail | Extend alliance material postcondition/utility only with new evidence; no M5 completion. `/root` | R0129 runtime/checkpoints retained; this progress branch pending integration |
| Natural `great_holy_war.0011` event continuation | R0129 `completed-red`; new product B0, zero event action | R0129 turn56/raw53392944, same frozen EXE SHA `2D00FF31?F83DB86` | Same R0129 manifest; first blocker `registered_contract_requires_extended_consumer` | Five definition options, one rendered/native option4; direct projection lacks `character_scope_matches_any` and `unique_character_scope_excludes`, semantic decision unavailable, no typed choice or next-turn event consumption. | Recover only from h2145 after official semantic treatment of #2146?2152 tail; no post-checkpoint dates credited. Prior R0127 source h2083 original/prepared lineage in manifest. | Exact-build original event and minimal registered-contract consumer, then bounded formal event action/postcondition/next turn. Do not guess from sole rendered option or expand general religion domain. `/root` | Runtime evidence retained; source repair not yet delivered |

- ????? h2083/raw53386440 ? 10,088 ??? 248 ?? h2145/raw53392392 ? **10,336/36,524 ?**???????????? 0/1???? 0/1????? 0/2?G2 3/8?? R0118 WarID251658364 ?? RED ???PRV008 ?????????

## 2026-09-22 R0131 ?? R0129 exact ???? RED

| Delivery gate / capability | Status | Formal entry | Artifact / source | Actual game and next-turn evidence | Restore evidence | B0/B1 gap / owner | Branch cleanup |
| --- | --- | --- | --- | --- | --- | --- | --- |
| R0129 `great_holy_war.0011` instance25 exact registered-contract continuation | R0131 `qualified` production-live loop for this observed event; previous consumer RED closed for this shape only | R0129 h2145 official cold restore; source `34e9d007`, frozen CK3 1.19.0.6 ordinary/xar_off; R0131 formal 250/250 | [R0131 immutable manifest](Z:/ck3_mod_rewrite/.task-tmp/RUN-001/war-h2145-continuation-source34e9d00-nolaunch-20260922/R0131-formal/R0131-evidence-manifest.json) SHA-256 `F0726A161C520BB77F01146599C08703A3445A607731B073AC48DFDE3EDF562E`; formal report `52570DDB?13BDF` | turn6 exact query; turn7 sole typed option5/native4, same-date paused `native:11`?`native:12` event25?null; turn8 next formal turn begins absent; later continuation qualified | h2479/raw53437416 save `203E291D?26B51` matches driver last_checkpoint, driver `12EDB33C?6698E` has #2480?2481 unpaired read-only tail; cleanup true, next run requires official restore | No natural succession, no general religion/holy-war completion. Old R0118 WarID251658364 RED remains; century gate 0/1. `/root` | R0131 runtime/save/driver retained; this progress branch pending integration |

- ????? R0129 h2145 ? 10,336 ??? 1,876 ?? **12,212/36,524 ?**???? 0/1????? 0/2?G2 3/8?PRV008 ?????????

## 2026-09-22 R0132 `health.7400` ???? RED

| Delivery gate / capability | Status | Formal entry | Artifact / source | Actual game and next-turn evidence | Restore evidence | B0/B1 gap / owner | Branch cleanup |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Natural `health.7400` exact registered event continuation | R0132 `completed-red`, new product B0; no event action | R0131 h2479 official prepare/rebind + no-launch GREEN ? R0132 formal frozen `34e9d007`, ordinary/xar_off | [R0132 immutable manifest](Z:/ck3_mod_rewrite/.task-tmp/RUN-001/war-h2479-continuation-source34e9d00-nolaunch-20260922/R0132-formal/R0132-evidence-manifest.json) SHA-256 `212CD8D21CC537D1226C8FCD50AE2396E036B740B47A1F582E882236C3C69480`; formal report `AE156BF0?46FB68` | 13/14; turn14/raw53439984 event29, one rendered option but registry `registered_contract_projection_drift`; `disabled_option_contract`?`native_option_indices_exact`?`saved_scope_names_exact`?`scope_types_cover_projection` all fail, selected_step=null. No typed option, independent postcondition or next-turn event consumption | h2493/raw53439672 save `8293562D?193E` matches driver last_checkpoint; driver `7BD0313D?5F61` has #2494?2498 unpaired tail incl successful life-advance #2497, requiring official restore; cleanup true | Exact-build original definition/scope and minimal registry projection fix, focused normal/-O then bounded same-frame live validation. Do not choose sole rendered option blindly. `/root` | R0132 runtime evidence retained; this progress branch pending integration |

- R0131 `great_holy_war.0011` exact event closure remains valid; R0118 WarID251658364 dangerous-route RED remains open. Durable time only 12,306/36,524 days; hundred-year/full-campaign/independent-seed gates 0/1?0/1?0/2?G2 3/8?PRV008 GO remains frozen.

## 2026-09-22 R0133-R0135 bounded evidence

| Delivery gate | Status | Evidence | Verified boundary and next step |
| --- | --- | --- | --- |
| M5 alliance projection | R0133 `GREEN_READ_ONLY`; M5 `not_started` | [Report](Z:/ck3_mod_rewrite_process_assets/g2-m5-alliance-readback-live-R0133/evidence/report.json) SHA `CFE5635392393AABC4A1C5B1643151CA5C5A4CDAC9FF91740FD3661442F1B3B9`; five-row projection SHA `C58A3279BCD544844298B9C53D1C635FC23384D6F76E112B092E2BB7A5DBCF3A` | 657 distinct final-legal candidates and five available rows; no typed action/date, material terms or joint budget decision. PR #108 master `4456c3a`; proceed with same-frame outcomes/commitment and formal selection. |
| Natural `trait_specific.4001` | R0134 133/134 `completed-red`; new B0 | [Manifest](Z:/ck3_mod_rewrite/.task-tmp/RUN-001/war-h2493-continuation-source9b76758-nolaunch-20260922/R0134-formal/R0134-evidence-manifest.json) SHA `42801678CCAD722076CB0F40897FD906A4A81869E9F8DEB46C95D296945B170A`; formal report SHA `375EF7A9666B36571D7DD45C27F769D3C38FFB9C7FC8F7E73B29076F73FABECB` | Turn134/raw53467536 event32, two rendered options; five extended checks unsupported, `registered_contract_requires_extended_consumer`; no event action. h2675/raw53467008 save `3B0E9B25...53DB` paired to driver `4FAC1B82...78732` last checkpoint; #2676-2680 unpaired. Exact-build consumer patch, focused normal/`-O`, bounded live replay; runtime assets retained. |
