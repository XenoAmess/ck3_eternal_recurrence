...
| M4 construction definition source | Private R730 and R735 actual definition_identity RED; true county definition lookup in progress | controlled same-feudal paused world source query, public OFF | R735 finalac manifestSHA BB020B20...B55B12, reportSHA B58DFA61...E05A58, DLLSHA11D5D488...EC27D1 | R735 registry_count7 first vtable0x441EF38 exact RTTI CCourtTypeSetting, final native legality not evaluated; actor29829/date53178312 unchanged, zero action/date | paired R697/R722 seed read-only, R735 PID102076/job/watchdog recycled; no construction restore | Actual wrong global B0; exact CBuildingType source then paused final legality+typed build/next turn; m4_closed_view | original finalac refs/worktree cleaned; new B0 branch active |
| FEUDAL selected 1066 model | R734 private setup-view identity RED after R731 early owner gate; public selector/start OFF | official MCP NewGame->Bookmarks plus guarded private read-only model | final-e655 manifestSHA E910DD2F...1675, artifactSHA B8B5D098...ECC13, DLLSHA CA11FB72...AC2F0AE | official Bookmarks tree real; private frontend_setup_view_unverified, key/date/candidate/government UNOBSERVED, no seed/action | R734 PID9512/job/watchdog recycled; no first1066 game checkpoint | Per-stage RTTI/unique named-root view and selected final feudal candidate; feudal_start_game | final-e655 prior temp refs/worktree cleaned; new B0 branch active; physical clean clone auto-review cleanup blocked |
