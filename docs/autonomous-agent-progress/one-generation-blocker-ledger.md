...
| M4 construction definition source | Private R730 RED; county fix static-ready, final replay queued | private paused source query, public OFF | R730 report SHAFDBBC651...4334; wrong registry CDomicileBuildingType at0x4172FA8; county final masterac4402 | R730 first_failed_index0, vtable_mismatch; zero action/date; true native source not evaluated | R697/R722 paired seed read-only | Final-source county paused truth and construction action absent; m4_closed_view | original work/root integration refs/worktree cleaned |
| FEUDAL selected 1066 model | Private R731 RED; owner fix static-ready, final replay queued | controlled read-only Bookmarks private frame, selector OFF | R731 old8ea manifestSHA187AD7B6...29D0; final-e655 new manifestSHAE910DD2F...1675 | R731 GUI owner unreadable; candidate keys unobserved, not count0; no selector/StartGame/seed | no 1066 game checkpoint exists | Owner-chain exact frame, selected key/date/government and typed start; feudal_start_game | original remote/local work and root integration refs/worktree cleaned; physical clean clone auto-review cleanup blocked |
| GEN034-C/D War | continuity GREEN, terminal/postwar evidence insufficient; 2/4 unchanged | official native-auto-run cold checkpoint | R732 source R729 pair, saved saveSHAF851EC40...AEE8/driverSHA59487623...AB50, nativef342/Python1f117ab | 6/6,+7 game days, Army50331957 real province2630->2631, sentinel move#160 once, next termination query available; no terminal | New process R732 same-goal, pair index178; terminal cold not tested | Same-frame three-way single final action, material postwar/truce and terminal cold; /root | prior War temp source refs already integrated/cleaned |
| M5 five distinct native legal family candidates | R733 private RED before candidate collection; public OFF | controlled finalab read-only native family query | manifestSHA2890804F...94614, masterab7899c, Release DLLSHAE4CC64EB...53EB5C; live report SHA4C9F61B6...A81D | preliminary campaign-root timed out before execution (pump7851->7851/executor0); candidate count unobserved, zero action/date | paired source unchanged, tracked CK3 recycled; marriage restore absent | Actual paused-pump timeout B0: m5_legal_scene; then five legal rows, joint score, typed action/postcondition/next turn | finalab source refs cleaned; R733 artifact preserved |
| Council four scenes / natural death | anchor-dependent, unadvertised | normal production strategy once legal scenes arise | R696 only already-councillor; natural health/succession pair observed | guest/pending/fireability and natural .1007 + heir continuation absent | ordinary paired anchors exist, natural heir cold absent | normal paused positive scenes; council_final_scenes/natural_death_event_gate | no new work refs |