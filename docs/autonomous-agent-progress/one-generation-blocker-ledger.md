...
|---|---|---|---|---|---|
| GEN-001 | B0 | 一代人 supervised runner | strict `one_generation` 合同已在正常交互桌面多次 production-live。GEN-029 cold GREEN 后正式 `cbbd3fab` 又完成 52 gameplay 并推进到 `53278752`；当前因 GEN-030 同日 event/sentinel-state 竞态停止。最新 durable checkpoint 为 `53278416 / history=6136 / 164A3960...02DE4`；CharacterID `29829` / episode 不变且存活 | 最小解除 GEN-030 后从最新 checkpoint 继续正式长跑；只提升真实 B0/B1，普通 bound 直接续跑，直到自然死亡、琉焰卿 committed scoring 与匹配 `terminal-settlement.json` | runner production-live；GEN-023/024/027/028/029 resolved；GEN-030 open；G1 未完成 |
