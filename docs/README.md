...
- [auto-upgrade-buildings-upstream.md](auto-upgrade-buildings-upstream.md) / [auto-upgrade-buildings-maintenance.md](auto-upgrade-buildings-maintenance.md) / [auto-upgrade-buildings-test-plan.md](auto-upgrade-buildings-test-plan.md) / [auto-upgrade-buildings-phase-2-plan.md](auto-upgrade-buildings-phase-2-plan.md) / [auto-upgrade-buildings-phase-3-plan.md](auto-upgrade-buildings-phase-3-plan.md) — “自动升级建筑”上游 3596580780 的逐文件冻结身份、1.19.0.6 维护与验收、605 条省份建筑即时升级二期，以及“只用国库／只用个人／优先国库”原生决议选项三期计划
