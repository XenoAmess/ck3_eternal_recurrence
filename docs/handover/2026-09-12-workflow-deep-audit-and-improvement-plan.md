...
> **后续指令覆盖（2026-09-13）：** 本文关于继续 P2 录像、双片制作和发布的建议已经被项目所有者取消。旧分析保留为方法论与历史证据；当前不制作宣传视频、不发布天朝二期，已知 T0 UI 问题闭环后直接推进 G2。现行口径见 [`2026-09-13 T0 人工测试冻结与 G2 优先级指令`](2026-09-13-t0-manual-test-hold-and-g2-priority.md)。
