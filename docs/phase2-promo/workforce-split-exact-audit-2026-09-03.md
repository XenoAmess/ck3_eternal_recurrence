...
| single-block stub (`B7`) | report SHA `79EFD09AD3C9D4C3AEB3A25157676B734517286D6D0AAAC9709ED2F46C857229`; 264-file / 14,335,064-byte tree with a 3,033,800-byte workforce stub timed out at `Total of : 881`, with frontend/history false and cleanup proven | coverage-limited threshold diagnostic; not functional GREEN |
