...
`zg361_stage10_player_publication_source_v3`，除 SAV0101、离线拓扑、产品树及 checkpoint 哈希外，还要求单玩家记录和
hash-bound 的 MCP 原生保存/live campaign-root provenance。旧 `.390` selector-positive 与 v2 收据均为历史合同，不再用于现行启动。
