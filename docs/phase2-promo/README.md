...
共享原版事件资产当前为 `160 contracts / 160 analysis / 9 observation keys`，production runtime 为 `299`。R372 已在同一
...
其选择前 RED observation 仍保留。当前 `ep3_story_cycle_admin_eunuch.1001` instance `988` 动作前 RED 已迁移为通用合同、analysis 与 observation。
