...
共享原版事件资产当前为 `160 contracts / 160 analysis / 8 observation keys`，production runtime 为 `299`。R372 已在同一
...
`epidemic_events.5009` instance `871` 的第二次合法交付；R374 当前在 `natural_disaster.7031` instance `978` 动作前 RED，通用合同、analysis 与 observation 已迁移。
