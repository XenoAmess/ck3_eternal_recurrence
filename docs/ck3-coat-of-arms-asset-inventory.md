...
| VFS receipt | `base_game_only`；胜者集 SHA-256 `B0FB6AAD58818D5731D2996F467FEEBDEEF55B2E0D5C32DFBDA83F54F7222474` |
...
DDS、fit index/feature sidecar 的精确长度/SHA/header/数值边界、注册角色、物理源路径唯一性、inventory 计数及 VFS 胜者集收据。
