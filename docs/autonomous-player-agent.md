...
| B. UI 驱动底座（进行中） | 窗口分类、OCR/像素反证、可靠点击、地图/HUD/事件通用恢复 | `20260822T102802Z-opening-4cc459ce` 已真实完成七次按钮提交、首轮祝福/咒痕并进入地图；下一步执行首个地图经营动作 |
...
- 尚未实机接线：规则页、通用 HUD/事件状态机、地图经营动作，以及独立 policy 进程与字段白名单。
