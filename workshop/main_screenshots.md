...
`e7592964603546f860b5d59ba00626819d8e0523`; blob, redirecting raw and release-asset URLs are forbidden.
...
| 7 | Glassfire Gaze | `xar_terminal_observer_nondebug3_20260821/07_trait_hover.png` | `0,150,1920,1230` | `screenshots/gallery/07_glassfire_gaze.jpg` | yes | no | no |
...
dimensions are 1600x900, except Gaze at 1920x1080 and the two courtier views at 1860x1145; every file is below 0.5 MB.
